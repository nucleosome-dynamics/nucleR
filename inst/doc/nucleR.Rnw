...
<<peaks>>=
peaks = peakDetection(htseq_fft, threshold=0.25, score=FALSE)
peaks
@

<<plotpeak>>=
plotPeaks(peaks, htseq_fft, threshold=0.25)
@
...
plotPeaks(peaks, htseq_fft, threshold=0.25, yaxt="n", ylab="coverage")
@
...
<<peaks2>>=
peaks = peakDetection(htseq_fft, threshold=0.25, score=TRUE)
head(peaks)
@
...
par(cex=0.7, mar=c(5,4,1,1))
plotPeaks(peaks, htseq_fft, threshold=0.25, yaxt="n", xlim=c(1,4000), ylab="coverage")
@
...
<<peaks3>>=
peaks = peakDetection(htseq_fft, threshold=0.25, score=TRUE, width=140)
head(peaks)
@
...
par(cex=0.7, mar=c(5,4,1,1))
plotPeaks(peaks, htseq_fft, threshold=0.25, yaxt="n", xlim=c(1,4000), rect.lwd=0.5, rect.thick=2.5, ylab="coverage")
@
...
par(cex=0.7, mar=c(5,4,1,1))
plotPeaks(red_calls, htseq_fft, threshold=0.25, yaxt="n", xlim=c(1,4000), rect.lwd=0.5, rect.thick=3, ylab="coverage")
@
